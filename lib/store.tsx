...
import { Announcement, PassingCriterion, Student, ResultField, Exam, ExamQuestion, ExamAttempt, ViolationType, QuranReview, DailyRatingEntry, DailyRating, PerformanceFine, TestFine, AudioSubmission, Section } from "./types";
