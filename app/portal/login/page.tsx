...
export default function PortalLoginPage() {
  ...
  return (
    <>
      <DbErrorBanner />
      <main className="min-h-screen flex items-center justify-center px-5 py-12 bg-[var(--bg)]">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-center text-[var(--ink-soft)] mt-2">Student / Parent and Admin access</p>
            ...
            <form onSubmit={submitStudent} className="mt-8 space-y-4">
              <div>
                ...
                <input
                  ...
                  autoFocus
                />
                <p className="mt-1.5 text-xs text-[var(--ink-faint)]">Provided to you by the academy when your child enrolled.</p>
              </div>
