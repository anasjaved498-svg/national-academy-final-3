    ...
    <div className="space-y-6">
      ...
      {student?.testStatus === "rejected" && (
        <div className="flex items-start gap-3 rounded-2xl bg-[var(--rose-tint)] border border-[var(--rose)]/30 p-5">
          ...
          <div>
            <p className="font-semibold text-[var(--rose)]">Online test access rejected</p>
            <p className="text-sm text-[var(--ink-soft)] mt-1">
              Your online test access has been rejected by the academy after review. Please contact the academy to
              discuss next steps.
            </p>
          </div>
        </div>
      ...
      {student?.testStatus === "warned" && (
        <div className="flex items-start gap-3 rounded-2xl bg-[var(--gold-soft)] border border-[var(--gold)]/30 p-5">
          ...
          <div>
            <p className="font-semibold text-[var(--heading)]">Online test warning</p>
            <p className="text-sm text-[var(--ink-soft)] mt-1">
              You have {student.consecutiveTestFails} consecutive online test fail{student.consecutiveTestFails === 1 ? "" : "s"}.
              {student.consecutiveTestFails >= 3
                ? " Your account is awaiting an academy decision; rejection is not automatic."
                : " One more consecutive fail will require academy review."}
            </p>
          </div>
        </div>
      )}
