    ...
    return (
      <div className="space-y-5">
        <div>
          ...
          <h1 className="font-display text-3xl mt-1 text-[var(--heading)]">Online tests unavailable</h1>
        </div>
        <div className="flex items-start gap-3 rounded-2xl bg-[var(--rose-tint)] border border-[var(--rose)]/30 p-5">
          <ShieldAlert size={20} className="text-[var(--rose)] mt-0.5 shrink-0" />
          <p className="text-sm text-[var(--ink-soft)]">Your online test access has been rejected by the academy. Please contact the academy if you need clarification.</p>
        </div>
      </div>
    );
  }
