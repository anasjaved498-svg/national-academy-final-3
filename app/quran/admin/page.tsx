...
import { Users, AlertTriangle, Ban, Megaphone, StickyNote } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        >
          ...
          <div>
            <p className="font-semibold text-[var(--ink)]">Send a Note</p>
            <p className="text-sm text-[var(--ink-soft)]">Attach a file, target a section</p>
          </div>
        </Link>
      </div>
    </div>
